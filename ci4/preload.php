...
// Path to the front controller (adjusted for separated structure)
...
class preload {
  ...
  private array $paths = [
    [
      ...
      'exclude' => [
        // Database drivers not needed for your project
        ...
        '/system/rewrite.php',
        '/Views/',
        // Third party and error-prone files
        '/system/ThirdParty/',
        // Additional production excludes
        '/system/Debug/',
    ...
    [
      'include' => __DIR__ . '/app',
      'exclude' => [
        // Exclude non-essential app directories
        '/Views/',
        '/Language/',
        '/Database/Migrations/',
        '/Database/Seeds/',
